...
class Pixels < Test::Unit::TestCase
  ...
  def test_dup
    ...
    assert_equal(true, img.match_pixel?(0,0, 100,150,200,255))
    assert_equal(true, dup.match_pixel?(0,0, 100,150,200,255))
    img.set_pixel(0,0, 1,1,1,1)
    assert_equal([1,1,1,1], img.get_pixel(0,0))
    assert_equal([100,150,200,255], dup.get_pixel(0,0))
    assert_equal(true, img.match_pixel?(0,0, 1,1,1,1))
    assert_equal(true, dup.match_pixel?(0,0, 100,150,200,255))
  end
  ...
  def test_get_set_match_pixels
    ...
    assert_equal(true, img.match_pixel?(0,0, 0,0,0,0))
